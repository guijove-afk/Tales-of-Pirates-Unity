...
namespace TOP.Gameplay
{
    ...
    public class PlayerController : NetworkBehaviour
    {
        ...
        public void RpcTakeDamage(int damage, Vector3 hitPosition)
        {
            ...
            var popupManager = FindObjectOfType<TOP.Systems.DamagePopupManager>();
        ...
        {
            Level++;
            var effectManager = FindObjectOfType<TOP.Systems.LevelUpEffectManager>();
...
namespace TOP.Player
{
    public class PlayerInventory : NetworkBehaviour
    {
        ...
        public void CmdDropItem(ushort slotIndex, int quantity, Vector3 dropPosition)
        {
            ...
            // Criar world item
            var worldItemManager = FindObjectOfType<WorldItemManager>();
        ...
        void Hit(GameObject hitObject = null)
        {
            ...
            if (hitObject != null)
            {
                ...
                if (targetStats != null)
                {
                    ...
                    // Mostrar popup
                    var popupManager = FindObjectOfType<DamagePopupManager>();
                    if (popupManager != null)
                    {
    ...
    public class WorldItemManager : MonoBehaviour
    {
        ...
        private void CreateAllScenes()
        {
            ...
            CreateScene(scenesPath, "GameScene", scene =>
            {
                ...
                // NavMesh
                var navMesh = ground.AddComponent<UnityEngine.AI.NavMeshSurface>();
        ...
        private void CreateAllPrefabs()
        {
            ...
            var netTransform = playerObj.AddComponent<NetworkTransform>();
            netTransform.syncDirection = NetworkTransform.SyncDirection.ServerToClient;
            ...
            // Transports
            var kcp = nmObj.AddComponent<kcp2k.KcpTransport>();
            // Unity 6 usa KCP por padrao no Mirror
            ...
            var worldItemNetTransform = worldItemObj.AddComponent<NetworkTransform>();
            worldItemNetTransform.syncDirection = NetworkTransform.SyncDirection.ServerToClient;
        ...
        private void SetupMirrorNetwork()
        {
            ...
            var existingNM = FindObjectOfType<TOP.Network.TOPNetworkManager>();
            if (existingNM == null)
            {
